...
new_prediction_probability = clf.predict_proba([[bill_length_mm, bill_depth_mm, flipper_length_mm, 
  body_mass_g, island_Biscoe, island_Dream, island_Torgerson, sex_female, sex_male]]) 
...
st.write("prediction probability {}".format(new_prediction_probability))
